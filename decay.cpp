...
// Jeœli Twoja ga³¹Ÿ nie ma sta³ej minimalnego tiku, u¿yj fallbacku:
...
void Decay::startDecay(Item* item, int32_t duration)
{
	...
	if (decayMap.empty()) {
		...
		// jeœli nowy timestamp jest wczeœniejszy ni¿ aktualna g³owa kolejki – przestaw event
...
void Decay::checkDecay()
{
	...
	// Jeœli zosta³y jeszcze wpisy, zaplanuj kolejny tik
	if (it != end) {
